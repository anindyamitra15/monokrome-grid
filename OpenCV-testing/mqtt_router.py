...
class cred:
    bots = []  # add all the bots at runtime
...
def on_message(client, userdata, message):
    ...
    if message.topic == cred.topicSub.PARENT + '/' + cred.topicSub.BOTLIST:
        ...
        cred.bots.append(chip_id)  # add bots to set
        print(cred.bots)
...
if __name__ == '__main__':
    ...
    while True:
        ...
        control(7892874, enums.motors.MOTOR_LEFT, direction=1, pwm=250)
        time.sleep(2)
        # demo 3: setting left motor to stop
        control(7892874, enums.motors.MOTOR_LEFT, direction=enums.directions.Stop, pwm=0)
        time.sleep(2)
        # demo 4: setting left motor reverse direction
        control(7892874, enums.motors.MOTOR_LEFT, direction=2, pwm=250)
        time.sleep(2)
        # demo 5: setting left motor pwm: 1023
        control(7892874, enums.motors.MOTOR_LEFT, pwm=1023)
        time.sleep(2)
        # demo 3: setting left motor to stop
        control(7892874, enums.motors.MOTOR_LEFT, direction=0, pwm=0)
        # # demo 6: setting both direction: reverse and pwm: 102 to left motor
        # control(7892874, enums.motors.MOTOR_LEFT, direction=2, pwm=102)

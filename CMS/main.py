...
pool = Pool(8)  # Creates a pool with ten threads; more threads = more concurrency.
...
# Variable to store the previous time of analysed frame #default
prev = 0

# recording the video and storing it in a .avi file
out = cv2.VideoWriter('output.mp4', cv2.VideoWriter_fourcc(*'XVID'), 30.0, (1920, 1080))  #res can be reduced to save storage space
#also camera dependent res
